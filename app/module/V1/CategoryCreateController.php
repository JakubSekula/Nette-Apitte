 ...
 * @Tag("Category")
 */
class CategoryCreateController extends BaseV1Controller
{
	 ...
	 * @Path("/create")
	 * @Method("POST")
	 * @Tag(name="request.dto", value="App\Domain\Api\Request\CreateCategoryReqDto")
	 */
	public function create(ApiRequest $request, ApiResponse $response): ApiResponse
	{
		/** @var CreateCategoryReqDto $dto */
		$dto = $request->getParsedBody();

		try {
			$this->categoryFacade->create($dto);
